...
ventana = Tk()
ventana.title("Calculadora Kasio PYTHON-2020")
ventana.geometry("400x600")
ventana.resizable(False,False)
ventana.configure(background="gray30")
...
Boton0 = Button(ventana,text="0",bg=color_boton,width=ancho_boton,
                height=alto_boton,command=lambda:click(0)).grid(row=1,column=0,pady=20)
...
BotonClear = Button(ventana,text="C",bg="red",width=ancho_boton,
                    height=alto_boton,command=limpiar).grid(row=5,column=3,pady=10)
BotonEXP = Button(ventana,text="EXP",bg=color_boton,width=ancho_boton,
                  height=alto_boton,command=lambda:click("exp")).grid(row=5,column=1,pady=10)
BotonIgual = Button(ventana,text="=",bg=color_boton,width=ancho_boton,
                    height=alto_boton,command=resultado).grid(row=5,column=2,pady=10)
...
Pantalla = Entry(ventana,font=("arial",20,"bold"),width=22,
                 borderwidth=10,background="white",textvariable=texto_pantalla)
